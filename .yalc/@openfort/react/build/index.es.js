...
class OpenfortError extends Error {
    constructor(message, type, data) {
        ...
        else if ((data === null || data === void 0 ? void 0 : data.error) instanceof Error) {
            super(data.error.message);
        }
        else {
            super(message);
...
const MetaMask = ({ background = false, ...props }) => (jsxs("svg", { ...props, style: background
        ...
        : undefined, width: "88", height: "88", viewBox: "0 0 88 88", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("path", { d: "M74.4066 73.7063L59.3305 69.249L47.9614 75.9975L40.0287 75.9941L28.6527 69.249L13.5835 73.7063L9 58.3408L13.584 41.2875L9 26.8697L13.584 9L37.1306 22.969H50.8595L74.4066 9L78.9906 26.8697L74.4066 41.2875L78.9906 58.3408L74.4066 73.7063Z", fill: "var(--ck-brand-metamask-01)" }), jsx("path", { d: "M13.587 9L37.1341 22.9788L36.198 32.5722L13.587 9ZM28.6567 58.3471L39.0172 66.1838L28.6567 69.2485V58.3471ZM38.189 45.3909L36.198 32.5791L23.452 41.2915L23.4451 41.288V41.2944L23.4846 50.2623L28.6532 45.3914L38.189 45.3909ZM74.4066 9L50.8595 22.9788L51.7927 32.5722L74.4066 9ZM59.3374 58.3471L48.9764 66.1838L59.3374 69.2485V58.3471ZM64.5455 41.2939V41.2875L64.5425 41.291L51.7961 32.5791L49.8051 45.3909H59.3369L64.509 50.2613L64.5455 41.2939Z", fill: "var(--ck-brand-metamask-01)" }), jsx("path", { d: "M28.6532 69.2485L13.584 73.7058L9 58.3471H28.6532V69.2485ZM38.1856 45.3875L41.0639 63.9097L37.0744 53.6109L23.4782 50.2613L28.6498 45.388L38.1856 45.3875ZM59.3369 69.2485L74.4066 73.7058L78.9906 58.3467H59.3369C59.3369 58.3471 59.3369 69.2485 59.3369 69.2485ZM49.8051 45.3875L46.9267 63.9097L50.9157 53.6109L64.513 50.2613L59.3379 45.388L49.8051 45.3875Z", fill: "var(--ck-brand-metamask-02)" }), jsx("path", { d: "M9 58.3408L13.584 41.2876H23.4417L23.4777 50.2584L37.0754 53.6079L41.0644 63.9063L39.0137 66.174L28.6532 58.3374H9V58.3408ZM78.9906 58.3408L74.4066 41.2876H64.5485L64.5125 50.2584L50.9157 53.6079L46.9262 63.9063L48.9764 66.174L59.3374 58.3374H78.9906V58.3408ZM50.8595 22.969H37.1306L36.1985 32.5624L41.0649 63.896H46.9267L51.7961 32.5624L50.8595 22.969Z", fill: "var(--ck-brand-metamask-03)" }), jsx("path", { d: "M13.584 9L9 26.8697L13.584 41.2875H23.4417L36.1945 32.5727L13.584 9ZM35.3368 49.1076H30.8711L28.4398 51.4743L37.0784 53.6006L35.3368 49.1042V49.1076ZM74.4066 9L78.9906 26.8697L74.4066 41.2875H64.5485L51.7961 32.5727L74.4066 9ZM52.6603 49.1076H57.1324L59.5637 51.4772L50.9152 53.6079L52.6603 49.1042V49.1076ZM47.958 69.8848L48.9769 66.1809L46.9262 63.9131H41.06L39.0098 66.1809L40.0282 69.8848", fill: "var(--ck-brand-metamask-04)" }), jsx("path", { d: "M47.958 69.8843V76.0005H40.0292V69.8843H47.958Z", fill: "var(--ck-brand-metamask-05)" }), jsx("path", { d: "M28.6567 69.2421L40.0356 75.9971V69.8809L39.0167 66.1775L28.6567 69.2421ZM59.3374 69.2421L47.958 75.9971V69.8809L48.9769 66.1775L59.3374 69.2421Z", fill: "var(--ck-brand-metamask-06)" })] }));
...
const Google = ({ ...props }) => (jsxs("svg", { viewBox: "0 0 128 128", ...props, children: [jsx("path", { fill: "#fff", d: "M44.59 4.21a63.28 63.28 0 0 0 4.33 120.9 67.6 67.6 0 0 0 32.36.35 57.13 57.13 0 0 0 25.9-13.46 57.44 57.44 0 0 0 16-26.26 74.3 74.3 0 0 0 1.61-33.58H65.27v24.69h34.47a29.72 29.72 0 0 1-12.66 19.52 36.2 36.2 0 0 1-13.93 5.5 41.3 41.3 0 0 1-15.1 0A37.2 37.2 0 0 1 44 95.74a39.3 39.3 0 0 1-14.5-19.42 38.3 38.3 0 0 1 0-24.63 39.25 39.25 0 0 1 9.18-14.91A37.17 37.17 0 0 1 76.13 27a34.3 34.3 0 0 1 13.64 8q5.83-5.8 11.64-11.63c2-2.09 4.18-4.08 6.15-6.22A61.2 61.2 0 0 0 87.2 4.59a64 64 0 0 0-42.61-.38" }), jsx("path", { fill: "#e33629", d: "M44.59 4.21a64 64 0 0 1 42.61.37 61.2 61.2 0 0 1 20.35 12.62c-2 2.14-4.11 4.14-6.15 6.22Q95.58 29.23 89.77 35a34.3 34.3 0 0 0-13.64-8 37.17 37.17 0 0 0-37.46 9.74 39.25 39.25 0 0 0-9.18 14.91L8.76 35.6A63.53 63.53 0 0 1 44.59 4.21" }), jsx("path", { fill: "#f8bd00", d: "M3.26 51.5a63 63 0 0 1 5.5-15.9l20.73 16.09a38.3 38.3 0 0 0 0 24.63q-10.36 8-20.73 16.08a63.33 63.33 0 0 1-5.5-40.9" }), jsx("path", { fill: "#587dbd", d: "M65.27 52.15h59.52a74.3 74.3 0 0 1-1.61 33.58 57.44 57.44 0 0 1-16 26.26c-6.69-5.22-13.41-10.4-20.1-15.62a29.72 29.72 0 0 0 12.66-19.54H65.27c-.01-8.22 0-16.45 0-24.68" }), jsx("path", { fill: "#319f43", d: "M8.75 92.4q10.37-8 20.73-16.08A39.3 39.3 0 0 0 44 95.74a37.2 37.2 0 0 0 14.08 6.08 41.3 41.3 0 0 0 15.1 0 36.2 36.2 0 0 0 13.93-5.5c6.69 5.22 13.41 10.4 20.1 15.62a57.13 57.13 0 0 1-25.9 13.47 67.6 67.6 0 0 1-32.36-.35 63 63 0 0 1-23-11.59A63.7 63.7 0 0 1 8.75 92.4" })] }));
const Facebook = ({ ...props }) => (jsxs("svg", { viewBox: "0 0 36 36", fill: "#0866ff", height: "36", width: "36", ...props, children: [jsx("path", { d: "M20.181 35.87C29.094 34.791 36 27.202 36 18c0-9.941-8.059-18-18-18S0 8.059 0 18c0 8.442 5.811 15.526 13.652 17.471L14 34h5.5l.681 1.87Z" }), jsx("path", { fill: "white", d: "M13.651 35.471v-11.97H9.936V18h3.715v-2.37c0-6.127 2.772-8.964 8.784-8.964 1.138 0 3.103.223 3.91.446v4.983c-.425-.043-1.167-.065-2.081-.065-2.952 0-4.09 1.116-4.09 4.025V18h5.883l-1.008 5.5h-4.867v12.37a18.183 18.183 0 0 1-6.53-.399Z" })] }));
const Twitter = ({ ...props }) => (jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "128", height: "128", viewBox: "0 0 128 128", children: jsx("path", { fill: "currentColor", strokeWidth: 0.104373, d: "M75.916 54.2 122.542 0h-11.05L71.008 47.06 38.672 0H1.376l48.898 71.164L1.376 128h11.05L55.18 78.303 89.328 128h37.296L75.913 54.2ZM60.782 71.79l-4.955-7.086-39.42-56.386h16.972L65.19 53.824l4.954 7.086 41.353 59.15h-16.97L60.782 71.793Z" }) }));
const Discord = ({ ...props }) => (jsx("svg", { width: "800px", height: "800px", viewBox: "0 -28.5 256 256", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", preserveAspectRatio: "xMidYMid", ...props, children: jsx("g", { children: jsx("path", { d: "M216.856339,16.5966031 C200.285002,8.84328665 182.566144,3.2084988 164.041564,0 C161.766523,4.11318106 159.108624,9.64549908 157.276099,14.0464379 C137.583995,11.0849896 118.072967,11.0849896 98.7430163,14.0464379 C96.9108417,9.64549908 94.1925838,4.11318106 91.8971895,0 C73.3526068,3.2084988 55.6133949,8.86399117 39.0420583,16.6376612 C5.61752293,67.146514 -3.4433191,116.400813 1.08711069,164.955721 C23.2560196,181.510915 44.7403634,191.567697 65.8621325,198.148576 C71.0772151,190.971126 75.7283628,183.341335 79.7352139,175.300261 C72.104019,172.400575 64.7949724,168.822202 57.8887866,164.667963 C59.7209612,163.310589 61.5131304,161.891452 63.2445898,160.431257 C105.36741,180.133187 151.134928,180.133187 192.754523,160.431257 C194.506336,161.891452 196.298154,163.310589 198.110326,164.667963 C191.183787,168.842556 183.854737,172.420929 176.223542,175.320965 C180.230393,183.341335 184.861538,190.991831 190.096624,198.16893 C211.238746,191.588051 232.743023,181.531619 254.911949,164.955721 C260.227747,108.668201 245.831087,59.8662432 216.856339,16.5966031 Z M85.4738752,135.09489 C72.8290281,135.09489 62.4592217,123.290155 62.4592217,108.914901 C62.4592217,94.5396472 72.607595,82.7145587 85.4738752,82.7145587 C98.3405064,82.7145587 108.709962,94.5189427 108.488529,108.914901 C108.508531,123.290155 98.3405064,135.09489 85.4738752,135.09489 Z M170.525237,135.09489 C157.88039,135.09489 147.510584,123.290155 147.510584,108.914901 C147.510584,94.5396472 157.658606,82.7145587 170.525237,82.7145587 C183.391518,82.7145587 193.761324,94.5189427 193.539891,108.914901 C193.539891,123.290155 183.391518,135.09489 170.525237,135.09489 Z", fill: "#5865F2", fillRule: "nonzero" }) }) }));
const Openfort = ({ ...props }) => (jsx("svg", { viewBox: "0 0 22 24", width: "22", height: "24", children: jsx("path", { fill: "currentColor", transform: "translate(0, 5) scale(0.13)", d: "m75.9 72.3h18.2v32.4h-18.2zm94.8 32.3h-18.2v-87.1h-135v87.1h-18.2v-105.2h13.5v-0.1h157.9v0.1zm-36.5-50.7h-0.1v50.7h-18.2v-50.7h-61.9v50.7h-18.2v-66.5-2.4h98.4z" }) }));
...
const OtherSocials = ({ ...props }) => {
    ...
    return (jsxs("div", { style: column, ...props, children: [jsxs("div", { style: row, children: [jsx("div", { style: cell, children: jsx(Google, {}) }), jsx("div", { style: cell, children: jsx(Facebook, {}) })] }), jsxs("div", { style: row, children: [jsx("div", { style: cell, children: jsx(Discord, {}) }), jsx("div", { style: cell, children: jsx(Twitter, {}) })] })] }));
};
const providersLogos = {
    google: jsx(Google, {}),
    twitter: jsx(Twitter, {}),
    facebook: jsx(Facebook, {}),
    discord: jsx(Discord, {}),
    apple: jsx(Apple, {}),
};
var Logos = {
...
`;
const Disclaimer$1 = styled(motion.div) `
  display: flex;
  align-items: center;
  justify-content: center;
...
const Modal = ({ open, pages, pageId, positionInside, inline, demo, onClose, onBack, onInfo, }) => {
    ...
    const currentDepth = context.route === routes.PROVIDERS
        ? 0
    ...
    const Content = (jsx(ResetContainer, { "$useTheme": (_e = demo === null || demo === void 0 ? void 0 : demo.theme) !== null && _e !== void 0 ? _e : themeContext.theme, "$useMode": (_f = demo === null || demo === void 0 ? void 0 : demo.mode) !== null && _f !== void 0 ? _f : themeContext.mode, "$customTheme": (_g = demo === null || demo === void 0 ? void 0 : demo.customTheme) !== null && _g !== void 0 ? _g : themeContext.customTheme, children: jsxs(ModalContainer, { role: "dialog", style: {
                ...
                position: positionInside ? 'absolute' : undefined,
                                ...
                                zIndex: 9,
                                transition: 'width 200ms ease',
                            } }), jsxs(BoxContainer, { className: `${rendered && 'active'}`, children: [jsx(AnimatePresence, { initial: false, children: context.errorMessage && (jsxs(ErrorMessage, { initial: { y: '10%', x: '-50%' }, animate: { y: '-100%' }, exit: { y: '100%' }, transition: { duration: 0.2, ease: 'easeInOut' }, children: [jsx("span", { children: context.errorMessage }), jsx("div", { onClick: () => context.displayError(null), style: {
                                                    position: 'absolute',
                                                    right: 24,
                                                    top: 24,
                                                    cursor: 'pointer',
                                                ...
                                                delay: mobile ? 0.01 : 0,
                                            }, children: jsx(FitText, { children: getHeading() }) }, `${context.route}-${"signedIn"}`) }) }), jsx(InnerContainer$1, { children: Object.keys(pages).map((key) => {
...
disabled, icon, iconPosition = 'left', roundedIcon, waiting, arrow, download, href, style, onClick, }) => {
    ...
    return (jsx(ButtonContainer, { className: className, as: href ? 'a' : undefined, onClick: (event) => {
            if (!disabled && onClick)
                onClick(event);
        }, href: href && hrefUrl, target: href && '_blank', rel: href && 'noopener noreferrer', disabled: disabled, "$variant": variant, style: style, children: jsxs(AnimatePresence, { initial: false, children: [jsxs(ButtonContainerInner, { initial: { opacity: 0, y: -10 }, animate: {
                        opacity: 1,
                        y: -1,
                    }, exit: {
                        position: 'absolute',
...
const Wallet$1 = ({ inverted = false }) => (jsxs("svg", { width: "58", height: "50", viewBox: "0 0 58 50", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M57.9332 20.3335V42.1113C57.9332 46.4069 54.451 49.8891 50.1555 49.8891H8.15546C3.85991 49.8891 0.377686 46.4069 0.377686 42.1113V25.0002V7.8891C0.377686 3.59355 3.85991 0.111328 8.15546 0.111328H47.0444C48.7626 0.111328 50.1555 1.50422 50.1555 3.22244C50.1555 4.94066 48.7626 6.33355 47.0443 6.33355H9.71102C7.9928 6.33355 6.59991 7.72644 6.59991 9.44466C6.59991 11.1629 7.9928 12.5558 9.71102 12.5558H50.1555C54.451 12.5558 57.9332 16.038 57.9332 20.3335ZM46.2667 34.3337C48.4145 34.3337 50.1556 32.5926 50.1556 30.4448C50.1556 28.297 48.4145 26.5559 46.2667 26.5559C44.1189 26.5559 42.3778 28.297 42.3778 30.4448C42.3778 32.5926 44.1189 34.3337 46.2667 34.3337Z", fill: inverted
    ...
    return (jsxs("div", { style: {
            ...
            justifyContent: 'center',
                    ...
                    height: 112,
                        ...
                        opacity: 0,
                    }, animate: { opacity: 1 }, exit: { opacity: 0 }, children: [jsx(BgLighten, {}), jsx(motion.div, { style: { zIndex: 2, position: 'relative' }, children: jsx(Wallet$1, {}) })] }, 'SlideOneInner') }, layoutId), jsx(motion.div, { initial: { rotate: -90, scale: 0.2, x: '-100%' }, animate: { rotate: 0, scale: 1, x: 0 }, exit: { rotate: -40, scale: 0.1, x: '-70%' }, style: {
                    zIndex: 4,
                    position: 'relative',
                    width: 76,
                    height: 76,
...
const SlideTwo = ({ layoutId }) => {
    return (jsx(Fragment, { children: jsxs("div", { style: {
                ...
                left: -14,
                        ...
                        }, children: jsx(Center, { children: jsx(Wallet$1, {}) }) }, 'SlideTwoInner') }, layoutId), jsxs(motion.div, { initial: { scale: 0.2 }, animate: { scale: 1 }, exit: { scale: 0.2 }, style: {
                        zIndex: 7,
                        position: 'relative',
                        display: 'flex',
                        alignItems: 'center',
                                    ...
                                    return (jsxs(WalletItem, { onClick: () => connectWallet(walletId), style: {
                                            animationDelay: `${i * 50}ms`,
                                                    ...
                                                    justifyContent: 'center',
                                                        ...
                                                        width: '50%',
                                                    }, children: jsx(Spinner$4, {}) }) })) : (MoreIcon) }), jsx(WalletLabel, { children: locales.more })] })] }) }) }), ((_b = context.uiConfig) === null || _b === void 0 ? void 0 : _b.walletConnectCTA) !== 'modal' && (jsx("div", { style: {
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        gap: 14,
...
`;
const Unsupported$1 = styled(motion.div) `
  z-index: 2;
  width: 100%;
  height: 100%;
  min-width: 13px;
...
`;
const LinkedProviderContainer = styled(motion.div) `
  display: flex;
  align-items: center;
  justify-content: center;
  flex-wrap: wrap;
  gap: 8px;
`;
const LinkedProviderButton = styled(Button) `
  width: 50px;
  margin: 0px;
...
`;
const ProvidersHeader = styled(motion.h3) `
  font-size: 14px;
  margin-bottom: 4px;
  font-weight: bold;
  color: var(--ck-body-color);
...
var Wallet = ({ ...props }) => {
    return (jsxs("svg", { "aria-hidden": "true", width: "20", height: "19", viewBox: "0 0 20 19", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: [jsx("path", { d: "M1.57568 4.60616C1.57568 2.69827 3.12234 1.15161 5.03023 1.15161H15.3939C17.3018 1.15161 18.8484 2.69826 18.8484 4.60616V10.3637C18.8484 12.2716 17.3018 13.8183 15.3939 13.8183H5.03023C3.12234 13.8183 1.57568 12.2716 1.57568 10.3637V4.60616Z", stroke: "currentColor", strokeWidth: "1.25" }), jsx("path", { d: "M1 4.79293C1 2.435 3.31004 0.770014 5.54697 1.51566L12.4561 3.81869C13.8667 4.2889 14.8182 5.60901 14.8182 7.09596V13.6313C14.8182 15.9892 12.5081 17.6542 10.2712 16.9086L3.36212 14.6056C1.95149 14.1353 1 12.8152 1 11.3283V4.79293Z", fill: "var(--ck-body-background)", stroke: "currentColor", strokeWidth: "1.25" }), jsx("circle", { cx: "10.3863", cy: "10.1894", r: "1.32574", fill: "currentColor" })] }));
};
...
const createSIWEMessage = (address, nonce, chainId) => createSiweMessage({
...
const ConnectWithQRCode = ({ switchConnectMethod }) => {
    ...
    return (jsxs(PageContent, { children: [jsxs(ModalContent, { style: { paddingBottom: 8, gap: 14 }, children: [jsx(CustomQRCode, { value: uri, image: wallet === null || wallet === void 0 ? void 0 : wallet.icon, tooltipMessage: isWalletConnectConnector(id) ? (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, {}), jsx("span", { children: locales.scanScreen_tooltip_walletConnect })] })) : (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, { logo: wallet === null || wallet === void 0 ? void 0 : wallet.icon }), jsx("span", { children: locales.scanScreen_tooltip_default })] })) }), showAdditionalOptions ? (jsx(OrDivider, {})) : (hasApps && jsx(OrDivider, { children: locales.dontHaveTheApp }))] }), showAdditionalOptions && ( // for walletConnect
            jsxs("div", { style: {
                    ...
                    justifyContent: 'center',
                    gap: 14,
                }, children: [((_e = context.uiConfig) === null || _e === void 0 ? void 0 : _e.walletConnectCTA) !== 'modal' && (jsx(CopyToClipboard, { variant: "button", string: uri, children: ((_f = context.uiConfig) === null || _f === void 0 ? void 0 : _f.walletConnectCTA) === 'link'
                            ? locales.copyToClipboard
                            : locales.copyCode })), ((_g = context.uiConfig) === null || _g === void 0 ? void 0 : _g.walletConnectCTA) !== 'link' && (jsx(Button, { icon: jsx(ExternalLinkIcon, {}), onClick: openW3M, disabled: isOpenW3M, waiting: isOpenW3M, children: ((_h = context.uiConfig) === null || _h === void 0 ? void 0 : _h.walletConnectCTA) === 'modal'
        ...
        (async () => {
            ...
            switch (status) {
                ...
                case states$2.REDIRECT:
                    ...
                    const queryParams = Object.fromEntries([...url.searchParams.entries()].filter(([key]) => [
                        "openfortAuthProviderUI",
                        "refresh_token",
                        "access_token",
                        "player_id",
...
const PasswordInput = ({ ...props }) => {
    ...
    return (jsxs(InputContainer, { children: [jsx(Input$1, { ...props, style: { paddingRight: '48px', ...props.style }, type: showPassword ? 'text' : 'password' }), jsx(IconButton, { type: 'button', onClick: () => setShowPassword(!showPassword), children: showPassword ?
                    jsx(EyeIcon, {}) :
                    jsx(EyeOffIcon, {}) })] }));
};
const Input = ({ ...props }) => {
    if (props.type === 'password')
        return jsx(PasswordInput, { ...props });
...
const useConnectToWalletPostAuth = () => {
    ...
    const queryClient = useQueryClient();
    const tryUseWallet = useCallback(async ({ logoutOnError: signOutOnError = true, recoverWalletAutomatically }) => {
        if ((walletConfig === null || walletConfig === void 0 ? void 0 : walletConfig.recoverWalletAutomaticallyAfterAuth) === false && recoverWalletAutomatically === undefined) {
            return {};
        }
...
const RequestEmail = () => {
    ...
    return (jsx(PageContent, { children: jsxs("form", { onSubmit: (e) => {
                e.preventDefault();
                handleSubmit();
            }, children: [jsx(Input, { style: { marginTop: 0 }, value: email, onChange: (e) => setEmail(e.target.value), type: "email", placeholder: "Enter your email", disabled: loading }), error && (jsx(ModalBody, { style: { marginTop: 12 }, "$error": true, children: jsx(FitText, { children: error }) })), jsx(Button, { onClick: handleSubmit, disabled: loading || !!message, waiting: loading, children: message ? message : "Send reset email" })] }) }));
};
const ResetPassword = () => {
    const fixedUrl = window.location.href.replace("?state=", "&state="); // redirectUrl is not working with query params
    const url = new URL(fixedUrl);
    ...
    return (jsx(PageContent, { children: jsxs("form", { onSubmit: (e) => {
                e.preventDefault();
                handleSubmit();
            }, children: [jsx(FitText, { children: email ? `Reset password for ${email}` : "Reset password" }), jsx(Input, { value: password, onChange: (e) => setPassword(e.target.value), type: "password", placeholder: "Enter your new password", disabled: loading }), jsx(Button, { onClick: handleSubmit, disabled: loading, waiting: loading, children: "Reset password" })] }) }));
};
const ForgotPassword = () => {
    const url = new URL(window.location.href);
    const isRequestingEmail = !url.searchParams.get("openfortForgotPasswordUI");
    if (isRequestingEmail)
        return jsx(RequestEmail, {});
    else
...
const RecoverPasskeyWallet = ({ wallet }) => {
    ...
    return (jsx(PageContent, { children: jsx(Loader, { icon: jsx(FingerPrintIcon, {}), isError: !!recoveryError, header: recoveryError ? "Invalid passkey." : `Recovering wallet ${walletDisplay} with passkey...`, description: recoveryError ? "There was an error creating your passkey. Please try again." : undefined, onRetry: () => recoverWallet() }) }));
};
...
const ConnectModal = ({ mode = 'auto', theme = 'auto', customTheme = customThemeDefault, lang = 'en-US' }) => {
    ...
    const closeable = !(((_a = context.uiConfig) === null || _a === void 0 ? void 0 : _a.enforceSupportedChains) &&
        isConnected &&
        !chainIsSupported);
    const mainRoutes = [
        routes.PROFILE,
    ...
    return (jsx(ConnectKitThemeProvider, { theme: theme, customTheme: customTheme, mode: mode, children: jsx(Modal, { open: context.open, pages: pages, pageId: context.route, onClose: closeable ? hide : undefined, 
...
const Balance = ({ hideIcon, hideSymbol }) => {
    ...
    return (jsx("div", { style: { position: 'relative' }, children: jsx(AnimatePresence, { initial: false, children: jsx(motion.div, { initial: (balance === null || balance === void 0 ? void 0 : balance.formatted) !== undefined && isInitial
                    ...
                    ease: [0.25, 1, 0.5, 1],
                    delay: 0.4,
                }, children: !address || !isMounted || (balance === null || balance === void 0 ? void 0 : balance.formatted) === undefined ? (jsxs(Container, { children: [!hideIcon && jsx(Chain, { id: chain === null || chain === void 0 ? void 0 : chain.id }), jsx("span", { style: { minWidth: 32 }, children: jsxs(PulseContainer, { children: [jsx("span", { style: { animationDelay: '0ms' } }), jsx("span", { style: { animationDelay: '50ms' } }), jsx("span", { style: { animationDelay: '100ms' } })] }) })] })) : !isChainSupported ? (jsxs(Container, { children: [!hideIcon && jsx(Chain, { id: chain === null || chain === void 0 ? void 0 : chain.id }), jsx("span", { style: { minWidth: 32 }, children: "???" })] })) : (jsxs(Container, { children: [!hideIcon && jsx(Chain, { id: chain === null || chain === void 0 ? void 0 : chain.id }), jsx("span", { style: { minWidth: 32 }, children: nFormatter(Number(balance === null || balance === void 0 ? void 0 : balance.formatted)) }), !hideSymbol && ` ${balance === null || balance === void 0 ? void 0 : balance.symbol}`] })) }, state) }) }));
};
    ...
    return (jsx(ResetContainer, { "$useTheme": theme !== null && theme !== void 0 ? theme : (_c = context.uiConfig) === null || _c === void 0 ? void 0 : _c.theme, "$useMode": mode !== null && mode !== void 0 ? mode : context.mode, "$customTheme": customTheme !== null && customTheme !== void 0 ? customTheme : (_d = context.uiConfig) === null || _d === void 0 ? void 0 : _d.customTheme, children: jsxs(ThemeContainer, { onClick: () => {
                if (onClick) {
                    ...
                    open();
                        ...
                        showBalance &&
                        address &&
                        (theme === 'retro' || ((_j = context.uiConfig) === null || _j === void 0 ? void 0 : _j.theme) === 'retro')
                        ? {
...
const useLoginWithSiwe = () => {
    const { client, updateUser } = useOpenfortCore();
    const { log } = useOpenfort();
    const generateSiweNonce = useCallback(async ({ address, ecosystemGame }) => {
        if (!address) {
            throw new Error("An address is required to generate a SIWE nonce.");
        }
        const { nonce } = await client.auth.initSIWE({ address, ecosystemGame });
        return nonce;
    }, [client]);
    const loginWithSiwe = useCallback(async ({ message, signature, connectorType = "external", walletClientType = "external", }) => {
        if (!message || !signature) {
            throw new Error("Both message and signature are required to login with SIWE.");
        }
        log("Authenticating with SIWE", { connectorType, walletClientType });
        await client.auth.authenticateWithSIWE({
            message,
            signature,
            connectorType,
...
function useAuthorization() {
    const { client } = useOpenfortCore();
    const signAuthorization = useCallback(async (parameters) => {
        var _a;
        if (!client) {
        ...
        try {
            ...
            const address = (_a = authorization.contractAddress) !== null && _a !== void 0 ? _a : authorization.address;
            if (!address) {
                throw new OpenfortError('Authorization is missing an address to sign for.', OpenfortErrorType.VALIDATION_ERROR);
            }
            return {
                address,
...
export { UIAuthProvider as AuthProvider, Avatar, Chain as ChainIcon, OPENFORT_VERSION, OpenfortButton, OpenfortError, OpenfortErrorType, OpenfortProvider, OpenfortStatus, embeddedWalletId, defaultConfig as getDefaultConfig, defaultConnectors as getDefaultConnectors, useAuthCallback, useAuthorization, useChainIsSupported, useChains, useConnectWithSiwe, useEmailAuth, useGuestAuth, useLoginWithSiwe, useOAuth, useOpenfortCore as useOpenfort, useSignOut, useStatus, useUI, useUser, useWallet, useWalletAuth, useWallets, wallets };
